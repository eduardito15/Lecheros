 ...
 * @author Edu
 */
public class MantenimientoPrecios extends javax.swing.JDialog {
     ...
     */
    public MantenimientoPrecios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
                ...
                if(resp == JOptionPane.YES_OPTION){
                    if("0.0".equals(jTextFieldPrecioVenta.getText().trim())||"".equals(jTextFieldPrecioVenta.getText().trim())){
                        ...
                        if(precioCompra>precioVenta){
                            JOptionPane.showMessageDialog(this, "El precio de Compra no puede ser menor que el precio de Venta.","Información",JOptionPane.INFORMATION_MESSAGE);
                            jTextFieldPrecioCompra.requestFocus();
                            jTextFieldPrecioCompra.selectAll();
                        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MantenimientoPrecios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MantenimientoPrecios dialog = new MantenimientoPrecios(new javax.swing.JFrame(), true);
