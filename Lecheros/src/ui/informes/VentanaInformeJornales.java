 ...
 * @author Edu
 */
public class VentanaInformeJornales extends javax.swing.JFrame {
     ...
     */
    public VentanaInformeJornales(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo1.setText("Jornales Y Pagos");
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        try {
            ...
            Thread worker = new Thread() {
                public void run() {
                    try {
                        String[][] informe = sisInformes.informeJornalesEntreFechasPorRubro(desdeFecha, hastaFecha, rg);
                        ...
                        JOptionPane.showMessageDialog(VentanaInformeJornales.this, Constantes.MensajeDeErrorGenerico, "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            };
            worker.start();
    ...
    public void cargarTabla(String[][] tabla) {
        ...
        for (int i = 0; i < tabla.length; i++) {
            ...
            for (int j = 0; j < tabla[i].length; j++) {
                ...
                if(j == 5) {
                    cantJornales = cantJornales + Integer.parseInt(tabla[i][j]);
                }
                object[j] = tabla[i][j];
            }
        ...
        jLabelCantDias.setText(Integer.toString(cantJornales));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaInformeJornales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaInformeJornales dialog = new VentanaInformeJornales(new javax.swing.JFrame(), true);
