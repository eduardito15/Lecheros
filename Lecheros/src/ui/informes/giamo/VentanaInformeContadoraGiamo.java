...
import sistema.SistemaInformesGiamo;
 ...
 * @author Edu
 */
public class VentanaInformeContadoraGiamo extends javax.swing.JDialog {

    private boolean mostrarMensajeFechaIncorrecta = true;
    /**
     * Creates new form VentanaInformeContadora
     */
    public VentanaInformeContadoraGiamo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButtonCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCrearActionPerformed
        ...
        Thread worker = new Thread() {
            public void run() {
                try {
                    SistemaInformesGiamo.getInstance().sacarInformeContadoraGiamo(desdeFecha, hastaFecha);
                    ...
                    JOptionPane.showMessageDialog(VentanaInformeContadoraGiamo.this, Constantes.MensajeDeErrorGenerico, "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        };
        worker.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaInformeContadoraGiamo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaInformeContadoraGiamo dialog = new VentanaInformeContadoraGiamo(new javax.swing.JFrame(), true);
