 ...
 * @author Edu
 */
public class InformeTotalVentaPorductosPorReparto extends javax.swing.JDialog {
    ...
    /**
     * Creates new form InformeTotalVentaPorductosPorReparto
     */
    public InformeTotalVentaPorductosPorReparto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public final void inicializarTabla() {
        ...
        modelo.addColumn("Devoluviones");
        modelo.addColumn("Sobrante");
    ...
    private void initComponents() {
        ...
        setTitle("Total de Venta de Productos por Reparto");
        ...
        jLabelTitulo.setText("Total de Venta de Productos por Reparto");
        ...
        jTableResultado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Descripción", "Existencia", "Compras", "Devoluciones", "Sobrante", "Diferencia"
            }
        ) {
    ...
    private void jButtonVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerActionPerformed
        ...
        if (jComboBoxReparto.getSelectedIndex() == 0) {
            ...
            Thread worker = new Thread() {
                public void run() {
                    try {
                        String[][] resultadoInforme = sisInformes.totalDeVentaDeProductosPorReparto(fechaDesde, fechaHasta, r);
                        ...
                        JOptionPane.showMessageDialog(InformeTotalVentaPorductosPorReparto.this, Constantes.MensajeDeErrorGenerico, "Error", JOptionPane.ERROR_MESSAGE);
                    }
        ...
        for (int i = 0; i < tabla.length; i++) {
            ...
            for (int j = 0; j < tabla[i].length; j++) {
                ...
                if(!"Total".equals(cod)){
                    ...
                    jLabelTotal.setText(df.format(Double.parseDouble(tabla[i][j+1])).replace(',', '.'));
                    break;
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformeTotalVentaPorductosPorReparto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InformeTotalVentaPorductosPorReparto dialog = new InformeTotalVentaPorductosPorReparto(new javax.swing.JFrame(), true);
