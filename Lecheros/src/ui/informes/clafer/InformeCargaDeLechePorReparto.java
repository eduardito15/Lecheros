 ...
 * @author Edu
 */
public class InformeCargaDeLechePorReparto extends javax.swing.JDialog {
    ...
    /**
     * Creates new form InformeCargaDeLechePorReparto
     */
    public InformeCargaDeLechePorReparto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public final void inicializarTabla() {
        ...
        modelo.addColumn("Anep");
        modelo.addColumn("Inau");
    ...
    private void initComponents() {
        ...
        jTableResultado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Reparto", "Codigo", "Compras", "Pinchadas", "Anep", "Inau", "Diferencia"
            }
        ) {
        ...
        jLabelTotalLitros.setFont(new java.awt.Font("Lucida Grande", 1, 15)); // NOI18N
        jLabelTotalLitros.setForeground(new java.awt.Color(0, 0, 255));
        jLabelTotalLitros.setText("0");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabelTotalLitros)
                .addGap(131, 131, 131))
        );
    ...
    private void jButtonVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerActionPerformed
        ...
        if (jComboBoxReparto.getSelectedIndex() == 0) {
            ...
            Thread worker = new Thread() {
                public void run() {
                    try {
                        String[][] resultadoInforme = sisInformes.cargaDeLechePorReparto(fechaDesde, fechaHasta, r);
                        ...
                        JOptionPane.showMessageDialog(InformeCargaDeLechePorReparto.this, Constantes.MensajeDeErrorGenerico, "Error", JOptionPane.ERROR_MESSAGE);
                    }
        ...
        for (int i = 0; i < tabla.length; i++) {
            ...
            for (int j = 0; j < tabla[i].length; j++) {
                ...
                if(!"Total".equals(cod)){
                    ...
                    jLabelTotalLitros.setText(df.format(Double.parseDouble(tabla[i][j+1])).replace(',', '.'));
                    break;
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformeCargaDeLechePorReparto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InformeCargaDeLechePorReparto dialog = new InformeCargaDeLechePorReparto(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JLabel jLabelTotalLitros;
