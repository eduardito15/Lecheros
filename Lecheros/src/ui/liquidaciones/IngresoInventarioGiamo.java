 ...
 * @author Edu
 */
public class IngresoInventarioGiamo extends javax.swing.JFrame {
    ...
    private InventarioGiamo inventario;
     ...
     */
    public IngresoInventarioGiamo(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
        ...
        modItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (jTableRenglones.isEnabled()) {
                    InventarioGiamoRenglon ir = inventario.getRenglones().get(jTableRenglones.getSelectedRow());
                    ...
                    VentanaModificarRenglonInventarioGiamo vmir = new VentanaModificarRenglonInventarioGiamo(IngresoInventarioGiamo.this, true);
                    ...
                    JOptionPane.showMessageDialog(IngresoInventarioGiamo.this, "Primero ingrese la fecha y el reparto.", "Información", JOptionPane.INFORMATION_MESSAGE);
                    jDateChooserFecha.requestFocusInWindow();
                }
            } 
        });
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Inventario 2");
    ...
    private void jButtonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarActionPerformed
        ...
        if ("".equals(jTextFieldCodigoArticulo.getText().trim()) || "".equals(jTextFieldCantidadRenglon.getText().trim())) {
            ...
            try {
                InventarioGiamoRenglon ir = new InventarioGiamoRenglon();
    ...
    private void jTextFieldCodigoArticuloFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextFieldCodigoArticuloFocusGained
        ...
        if (jComboBoxReparto.getSelectedIndex() != 0 && inventario == null) {
            try {
                ...
                inventario = sis.devolverInventarioGiamoParaFechaYReparto(fechaInventario, (Reparto) jComboBoxReparto.getSelectedItem());
                if (inventario == null) {
                    //Es uno nuevo
                    this.setInventarioGiamo(new InventarioGiamo());
        ...
        try {
            if (SistemaUsuarios.getInstance().tienePermisos(Constantes.ActividadIngresarCompras)) { 
                ...
                //Date fechaCompra = jDateChooserFecha.getDate();
                    if (sis.actualizarInventarioGiamo(inventario)) {
                        this.dispose();
                    }
                //this.compra.setFecha(fechaCompra);
                //sisCompras.actualizarCompra(compra);
                    this.dispose();
                } else if (sis.guardarInventarioGiamo(inventario)) {
                    this.dispose();
                } else {

                }
            } else {
                JOptionPane.showMessageDialog(IngresoInventarioGiamo.this, "No tiene permisos para guardar un inventario.", "Permisos", JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (Exception e) {
            ...
            IngresoInventarioGiamo vinv = new IngresoInventarioGiamo(null, false);
    ...
    private void jButtonRefrescar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRefrescar2ActionPerformed
        // TODO add your handling code here:
        IngresoInventarioGiamo vg = new IngresoInventarioGiamo(null, false);
        vg.setVisible(true);
        this.dispose();
    ...
    public void cargarRenglonesInventario() {
        ...
        for (InventarioGiamoRenglon ir : this.inventario.getRenglones()) {
            Object[] object = new Object[6];
            object[0] = ir.getArticulo().getCodigo();
            object[1] = ir.getArticulo().getDescripcion();
            object[2] = ir.getCantidad();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IngresoInventarioGiamo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IngresoInventarioGiamo dialog = new IngresoInventarioGiamo(new javax.swing.JFrame(), true);
     ...
     */
    public void setInventarioGiamo(InventarioGiamo inventario) {
