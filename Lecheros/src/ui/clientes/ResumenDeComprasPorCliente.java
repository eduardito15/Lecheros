 ...
 * @author Edu
 */
public class ResumenDeComprasPorCliente extends javax.swing.JFrame {
     ...
     */
    public ResumenDeComprasPorCliente(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo1.setText("Resumen de Compras Por Cliente");
        ...
        jTableResultado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Artículo", "Compras", "Devoluciones", "Total"
            }
        ) {
    ...
    private void jButtonVerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVerActionPerformed
        ...
        if (!"".equals(jTextFieldCliente.getText().trim())) {
            ...
            Thread worker = new Thread() {
                public void run() {
                    try {
                        resultado = sisInformes.resumenDeComprasPorCliente(desdeFecha, hastaFecha, cliente);
                    } catch (Exception exp) {
                        ...
                        JOptionPane.showMessageDialog(ResumenDeComprasPorCliente.this, Constantes.MensajeDeErrorGenerico, "Error", JOptionPane.ERROR_MESSAGE);
                    }
    ...
    private void jTextFieldClienteKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldClienteKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if ("".equals(jTextFieldCliente.getText().trim())) {
                ...
                VentanaBuscadorClienteTodos vbc = new VentanaBuscadorClienteTodos(ResumenDeComprasPorCliente.this, true);
                vbc.setVisible(true);
    ...
    private void jButtonRefrescarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRefrescarActionPerformed
        // TODO add your handling code here:
        ResumenDeComprasPorCliente vrdcpc = new ResumenDeComprasPorCliente(null, false);
        ...
        for (int i = 0; i < tabla.length; i++) {
            ...
            for (int j = 0; j < tabla[i].length; j++) {
                ...
                if (!"Total".equals(cod)) {
                    ...
                    jLabelTotalCliente.setText(df.format(Double.parseDouble(tabla[i][j+1])).replace(',', '.'));
                    break;
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResumenDeComprasPorCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ResumenDeComprasPorCliente dialog = new ResumenDeComprasPorCliente(new javax.swing.JFrame(), true);
