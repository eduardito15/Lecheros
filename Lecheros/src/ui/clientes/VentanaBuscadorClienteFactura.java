 ...
 * @author Edu
 */
public class VentanaBuscadorClienteFactura extends javax.swing.JDialog {
     ...
     */
    public VentanaBuscadorClienteFactura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jTextFieldBuscarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBuscarKeyPressed
        ...
        if(Character.isLetter(ch) || Character.isDigit(ch) || Character.isSpaceChar(ch)){
            ...
            for(Cliente c : clientes){
                if(c.getNombre().toLowerCase().contains(textoBusqueda.toLowerCase()) || c.getRazonSocial().toLowerCase().contains(textoBusqueda.toLowerCase())){
                     modelo.addElement(c);
                }
            }
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        // TODO add your handling code here:
        setClientes(sis.devolverClientesPorRepartoEstadoYTipo(this.reparto, true, esProrrateo));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaBuscadorClienteFactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaBuscadorClienteFactura dialog = new VentanaBuscadorClienteFactura(new javax.swing.JFrame(), true);
    ...
    /**
     * @param esProrrateo the esProrrateo to set
     */
    public void setEsProrrateo(boolean esProrrateo) {
        this.esProrrateo = esProrrateo;
    }
}
