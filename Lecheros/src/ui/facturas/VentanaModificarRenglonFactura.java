 ...
 * @author Edu
 */
public class VentanaModificarRenglonFactura extends javax.swing.JDialog {

    private FacturaRenglon facturaRenglon;
    private final SistemaMantenimientoArticulos sisArticulos;
    /**
     * Creates new form VentanaModificarRenglonCompra
     */
    public VentanaModificarRenglonFactura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButtonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAceptarActionPerformed
        ...
        try {
            ...
            facturaRenglon.setArticulo(a);
            facturaRenglon.setCantidad(cantidad);
            Precio p = sisArticulos.devolverPrecioParaFechaPorArticulo(a, facturaRenglon.getFactura().getFecha());
            if (p != null) {
                //Cargo el objeto renglon de compra
                facturaRenglon.setPrecio(p.getPrecioVenta());
                facturaRenglon.setSubtotal(p.getPrecioVenta() * facturaRenglon.getCantidad());
                facturaRenglon.setIva((facturaRenglon.getSubtotal() * a.getIva().getPorcentaje() / 100));
                facturaRenglon.setTotal(facturaRenglon.getSubtotal() + facturaRenglon.getIva());
                //facturaRenglon.setTotalPrecioVentaSinIva(p.getPrecioVenta() * facturaRenglon.getCantidad());
                //facturaRenglon.setTotalPrecioVentaConIva(facturaRenglon.getTotalPrecioVentaConIva() + ((p.getPrecioVenta() * facturaRenglon.getCantidad()) * a.getIva().getPorcentaje() / 100));
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        // TODO add your handling code here:
        jTextFieldCodigoArticuloMod.setText(Integer.toString(facturaRenglon.getArticulo().getCodigo()));
        jLabelDescripcionArtMod.setText(facturaRenglon.getArticulo().getDescripcion());
        jTextFieldCantidadArticuloMod.setText(Double.toString(facturaRenglon.getCantidad()));
        jTextFieldCodigoArticuloMod.requestFocus();
        jTextFieldCodigoArticuloMod.selectAll();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaModificarRenglonFactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaModificarRenglonFactura dialog = new VentanaModificarRenglonFactura(new javax.swing.JFrame(), true);
    ...
    /**
     * @param facturaRenglon the compraRenglon to set
     */
    public void setFacturaRenglon(FacturaRenglon facturaRenglon) {
        this.facturaRenglon = facturaRenglon;
    }
}
