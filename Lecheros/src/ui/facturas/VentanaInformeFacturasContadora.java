 ...
 * @author Edu
 */
public class VentanaInformeFacturasContadora extends javax.swing.JDialog {

    private boolean mostrarMensajeFechaIncorrecta = true;
    /**
     * Creates new form VentanaInformeContadora
     */
    public VentanaInformeFacturasContadora(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo1.setText("Informe Facturas Contador");
    ...
    private void jButtonCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCrearActionPerformed
        ...
        Thread worker = new Thread() {
            public void run() {
                try {
                    SistemaFacturas.getInstance().sacarInformeFacturasContadora(desdeFecha, hastaFecha);
                } catch (Exception exp) {
                    ...
                    JOptionPane.showMessageDialog(VentanaInformeFacturasContadora.this, Constantes.MensajeDeErrorGenerico, "Error", JOptionPane.ERROR_MESSAGE);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaInformeFacturasContadora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaInformeFacturasContadora dialog = new VentanaInformeFacturasContadora(new javax.swing.JFrame(), true);
